...
class ConfigAndSchemaTests(unittest.TestCase):
    ...
    def test_quality_policy_snapshot_has_stable_version_and_fingerprint(self) -> None:
        ...
        self.assertEqual(config.retrieval_stage_timeout_seconds, 180.0)
        self.assertEqual(config.ranking_timeout_seconds, 180.0)
        self.assertEqual(config.embedding_timeout_seconds, 30.0)
        ...
        self.assertEqual(config.generation_section_workers, 2)
